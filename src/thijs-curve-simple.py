import numpy as np
from calc.par_simple import treasury_par_to_spot_curve_simple, cont_to_biannual
...
spot_r2 = cont_to_biannual(spot_r)

print('tenor  par     spot_c    spot_bi')
for t, r in zip(par_t, par_r):
    print(f'{t:3d}    {r*100:.2f}    {spot_r[t]*100:.4f}    {spot_r2[t]*100:.4f}')
